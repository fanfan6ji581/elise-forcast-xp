...
const QuizPage = () => {
    ...
    const solutionText = {
        ...
        mcq8: `The computer randomly selects 40% of the trials you played and computes your net accumulated outcomes in these trials. You receive that amount, up to $100. In case of a negative score, you leave the lab with $5.`,
    }
    ...
    return (
        <Container maxWidth="md">
            ...
            <form onSubmit={onSubmit}>
                ...
                <Typography variant="h5" sx={{ mt: 3 }}>
                    7. I can expect to leave the lab with $25 on average.
                </Typography>
                <RadioGroup sx={{ mx: 3 }} >
                    {
                        ["True", "False"].map((v, idx) =>
