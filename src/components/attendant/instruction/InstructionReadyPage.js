            ...
            <Grid container textAlign="center">
                <Grid item xs={12}>
                    ...
                    <Typography variant="h6" align="center" sx={{ my: 5 }}>
                        Remember that if you play well, you have fair chances to win the maximal amount ($110). However, the game is hard, and its pace is quick: you have only {xpConfig.afkTimeout / 1000} seconds to make your decision on each trial. If you do not reply within the imparted time,
